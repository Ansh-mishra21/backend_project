...
const getUserChannelProfile = asyncHandlers(async(req, res) => {
  const { username } = req.params  // params dynamic values deta hai 
  ...
  const channel = await User.aggregate([
    ...
    {  // channel pe total kitne subscribers hai 
      $lookup: {
        from: "subscriptions",
        localField: "_id",
    ...
    { // humne kitne channel ko subscribe kr rakha hai 
       $lookup: {
        from: "subscriptions",
        localField: "_id",
